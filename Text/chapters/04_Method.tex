...
All ML algorithms are performed through the standard function in the \textit{R} software package; their classifications are listen in table~\vref{tab:Tab_Class}.
%
